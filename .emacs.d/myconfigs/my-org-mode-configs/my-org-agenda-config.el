...
(setq org-agenda-files
	  ...
	  '("~/../../Downloads/GitRepositories/my-personal-things/Things to do/Bad habits that I need to quit.org"
	    ...
	    "~/../../Downloads/GitRepositories/my-personal-things/Things to do/Fixed Volume Tasks to move the needle on Long Term Goals.org"
	    "~/../../Downloads/GitRepositories/my-personal-things/Things to do/UrgentAndImportant.org"
	    "~/../../Downloads/GitRepositories/my-personal-things/Things to do/UrgentButNotImportant.org"
	    ...
	    "~/../../Downloads/GitRepositories/my-personal-things/Things to do/Notes in mindmap.org"
