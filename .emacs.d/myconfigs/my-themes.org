...
1. When I do have to use dark mode, these themes look good
   1. They come with emacs - don't have to install anything
   2. misterioso
   3. tsdh-dark
   4. dracula (doesn't come with emacs)
2. For day light, these themes lood good
   1. It feels like using emacs without themes is a pretty good way to go about things
   2. leuven - more pronounced headings
   3. tsdh-light
3. I used dracula theme for a long time and pretty happy with it.
